...
<head>
  ...
  <title>Gobindapur Govt. High School</title>  <!-- ===== CSS এখানে ===== -->  <style>
    body {
      margin: 0;
...
<body>  <header>
    ...
    <button onclick="adminLogin()" style="margin-left:10px;">🔐 Admin Login</button>
  </nav>  <div class="container"><!-- ===== Notice Section ===== -->
...
<div class="card" id="students">
  ...
  <ul id="studentList">
  ...
  </footer>  <!-- ===== JavaScript এখানে ===== -->  <script>
    function addNotice() {
    ...
    function loadNews() {
      ...
      // ===== Admin Login System (Button Based) =====
    const adminPassword = "1234"; // নিজের পাসওয়ার্ড দাও
